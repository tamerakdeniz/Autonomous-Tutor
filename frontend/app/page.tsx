    ...
    <div className="flex flex-col min-h-screen bg-gray-950 text-white">
      ...
      <header className="border-b border-gray-800 py-4 px-6">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/signup">
              <Button className="bg-white text-gray-900 hover:bg-gray-200">Sign Up</Button>
            </Link>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1">
        <div className="container mx-auto px-6 py-16 md:py-24 flex flex-col items-center text-center">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">Experience the power of AI conversation</h2>
          <p className="text-lg md:text-xl text-gray-400 max-w-3xl mb-10">
            Our advanced AI assistant helps you with answers, creative content, and problem-solving in a natural,
            conversational way.
          </p>
          <Link href="/signup">
            <Button size="lg" className="bg-white text-gray-900 hover:bg-gray-200 px-8 py-6 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            <div className="bg-gray-900 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Interact with our AI in a natural, conversational way just like chatting with a human.
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Generate creative content, from poetry and stories to code and business ideas.
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Get immediate responses to your questions and assistance with complex problems.
              </p>
            </div>
          </div>
        </div>
